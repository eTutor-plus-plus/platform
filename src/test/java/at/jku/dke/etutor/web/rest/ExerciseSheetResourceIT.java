...
public class ExerciseSheetResourceIT {
    ...
    public void testUpdateExerciseSheet() throws Exception {
        ...
        var result = restExerciseSheetMockMvc.perform(get("/api/exercise-sheet/{id}", id))
            .andExpect(status().isOk())
            .andReturn();
    ...
    public void testRemoveExerciseSheet() throws Exception {
        ...
        restExerciseSheetMockMvc.perform(delete("/api/exercise-sheet/{id}", id))
            .andExpect(status().isNoContent());

        restExerciseSheetMockMvc.perform(get("/api/exercise-sheet/{id}", id))
            .andExpect(status().isNotFound());
    }
    ...
    public void testGetExerciseDisplayList() throws Exception {
        ...
        List<ExerciseSheetDisplayDTO> displayList = TestUtil.convertCollectionFromJSONString(jsonData, ExerciseSheetDisplayDTO.class, List.class);
