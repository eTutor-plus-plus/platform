...
public non-sealed class AssignmentSPARQLEndpointService extends AbstractSPARQLEndpointService {
     ...
     * @param permissionManager    the injected permission manager
     */
    public AssignmentSPARQLEndpointService(RDFConnectionFactory rdfConnectionFactory, PermissionManager permissionManager) {
